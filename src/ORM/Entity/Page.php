 ...
 */
class Page extends AbstractEntity implements CampaignPublicationsInterface
{
    use SoftDeleteTrait;
     ...
     *
     * @var Collection
     * @ORM\OnetoMany(targetEntity="CampaignPublication", mappedBy="page", orphanRemoval=true)
